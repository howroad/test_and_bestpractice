...
(function(e, t, n) {
    ...
    v.fn = v.prototype = {
        ...
        close: function() {
            ...
            e._elemBack && e._elemBack(),
                /*i[0].className = i[0].style.cssText = "",*/   //       // 解决列表刷新后，延时卡顿问题
                n.title.html(""),
                n.content.html(""),
                n.buttons.html(""),
        ...
        lock: function() {
            ...
            return t.zIndex(),
                ...
                u[0].style.cssText = c + ";position:absolute;z-index:" + n + ";top:0;left:0;overflow:hidden;" + d,
                a[0].style.cssText = "height:100%;background:" + i.background + ";filter:alpha(opacity=0);opacity:0",*/
                $(u[0]).css({"position":"absolute","z-index":n,"top":0,"left":0,"overflow":"hidden","width":"100%","height":"100%"}),
                $(a[0]).css({"height": "100%","background":i.background,"filter":"alpha(opacity=0)","opacity":0}),
        ...
        unlock: function() {
            ...
            return n.stop().unbind(),
                ...
                e.config.duration ? n.animate({
                    ...
                    e.config.duration, s) : s(),*/  // 去掉动画效率，提高代码执行效率
                e._lock = !1,
                e
        },
        _getDOM: function() {
    ...
    v._templates = '<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title"></div><a class="aui_close" href="javascript:/*artDialog*/;">\u00d7</a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>',
        v.defaults = {
            ...
            opacity: .7,
            /*duration: 300,*/
            duration: 0,    // 动画时间设置为0，程序不使用动画效果，提高执行效率
            fixed: !1,
            left: "50%",
            top: "38.2%",
            zIndex: 1987,
