...
function  initDrop(id){
    ...
    if ($("#dropColumns_hiddenColumnEdit").length == 0) {
        ...
        for(var i=0;i<nstc.sf.dropColumns._columns.length;i++){
            ...
            chtml += '<div style="float:left;padding:15px;white-space:nowrap;"><input onpropertychange="checkbox_propertyChange(this)" type="checkbox" '+checkedStr+' name="columns" value="1" class="checkbox" /><SPAN onclick=click_checkbox(this) class="checkbox_bg"></SPAN><span style="margin-left:10px">'
